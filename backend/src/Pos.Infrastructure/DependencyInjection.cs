...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<EmployeeSyncService>();
        ...
        services.AddScoped<IPublicMarketingService, PublicMarketingService>();
        services.AddSingleton<CouponRateLimiter>();
        services.AddScoped<ICouponPublicUrlService, CouponPublicUrlService>();
